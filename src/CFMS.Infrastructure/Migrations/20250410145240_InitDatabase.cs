        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaUnitId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "SubCategoryId");
                    table.ForeignKey(
                        name: "NutritionPlan_NutritionPlanId_fkey",
                        column: x => x.NutritionPlanId,
                        principalTable: "NutritionPlan",
                        principalColumn: "NutritionPlanId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying", nullable: true),
                    IsHavest = table.Column<int>(type: "integer", nullable: true, defaultValue: 0),
                    Status = table.Column<int>(type: "integer", nullable: true, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resource_Equipment_EquipmentId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "FoodId");
                    table.ForeignKey(
                        name: "FK_Resource_Medicine_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ResourceId");
                    table.ForeignKey(
                        name: "InventoryRequestDetail_ResourceSupplierId_fkey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChickenBatch_ChickenId",
                table: "ChickenBatch",
                column: "ChickenId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrowthStage_NutritionPlanId",
                table: "GrowthStage",
                column: "NutritionPlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryRequestDetail_ResourceSupplierId",
                table: "InventoryRequestDetail",
