...
namespace CFMS.Domain.Migrations
{
    ...
    [Migration("20250208224008_AddUserLogRelations")]
    partial class AddUserLogRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.Userhealthlog", b =>
                {
                    b.Property<Guid>("Hlogid")
                        .HasColumnType("uuid")
                        .HasColumnName("hlogid");
                    ...
                    b.ToTable("userhealthlog", (string)null);
                });

            modelBuilder.Entity("CFMS.Domain.Entities.Userquantitylog", b =>
                {
                    b.Property<Guid>("Qlogid")
                        .HasColumnType("uuid")
                        .HasColumnName("qlogid");
                    ...
                    b.ToTable("userquantitylog", (string)null);
                });

            modelBuilder.Entity("CFMS.Domain.Entities.Uservaccinationlog", b =>
                {
                    b.Property<Guid>("Userid")
                        .HasColumnType("uuid")
                        .HasColumnName("userid");
                    ...
                    b.ToTable("uservaccinationlog", (string)null);
                });
            ...
            modelBuilder.Entity("HealthlogUser", b =>
                {
                    b.Property<Guid>("HealthLogsHlogid")
                        .HasColumnType("uuid");

                    b.Property<Guid>("UsersUserid")
                        .HasColumnType("uuid");

                    b.HasKey("HealthLogsHlogid", "UsersUserid");

                    b.HasIndex("UsersUserid");

                    b.ToTable("HealthlogUser");
                });

            modelBuilder.Entity("QuantitylogUser", b =>
                {
                    b.Property<Guid>("QuantityLogsQlogid")
                        .HasColumnType("uuid");

                    b.Property<Guid>("UsersUserid")
                        .HasColumnType("uuid");

                    b.HasKey("QuantityLogsQlogid", "UsersUserid");

                    b.HasIndex("UsersUserid");

                    b.ToTable("QuantitylogUser");
                });

            modelBuilder.Entity("UserVaccinationlog", b =>
                {
                    b.Property<Guid>("UsersUserid")
                        .HasColumnType("uuid");

                    b.Property<Guid>("VaccinationLogsVlogid")
                        .HasColumnType("uuid");

                    b.HasKey("UsersUserid", "VaccinationLogsVlogid");

                    b.HasIndex("VaccinationLogsVlogid");

                    b.ToTable("UserVaccinationlog");
                });
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.Userhealthlog", b =>
                {
                    b.HasOne("CFMS.Domain.Entities.Healthlog", "Hlog")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("userhealthlog_hlogid_fkey");
                    ...
                    b.HasOne("CFMS.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("userhealthlog_userid_fkey");
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.Userquantitylog", b =>
                {
                    b.HasOne("CFMS.Domain.Entities.Quantitylog", "Qlog")
                        .WithMany()
                        .HasForeignKey("Qlogid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("userquantitylog_qlogid_fkey");
                    ...
                    b.HasOne("CFMS.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("userquantitylog_userid_fkey");
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.Uservaccinationlog", b =>
                {
                    b.HasOne("CFMS.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("uservaccinationlog_userid_fkey");

                    b.HasOne("CFMS.Domain.Entities.Vaccinationlog", "Vlog")
                        .WithMany()
                        .HasForeignKey("Vlogid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("uservaccinationlog_vlogid_fkey");
            ...
            modelBuilder.Entity("HealthlogUser", b =>
                {
                    b.HasOne("CFMS.Domain.Entities.Healthlog", null)
                        .WithMany()
                        .HasForeignKey("HealthLogsHlogid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("QuantitylogUser", b =>
                {
                    b.HasOne("CFMS.Domain.Entities.Quantitylog", null)
                        .WithMany()
                        .HasForeignKey("QuantityLogsQlogid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UserVaccinationlog", b =>
                {
                    ...
                    b.HasOne("CFMS.Domain.Entities.Vaccinationlog", null)
                        .WithMany()
                        .HasForeignKey("VaccinationLogsVlogid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
