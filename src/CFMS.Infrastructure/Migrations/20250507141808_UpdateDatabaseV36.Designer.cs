...
namespace CFMS.Infrastructure.Migrations
{
    ...
    [Migration("20250507141808_UpdateDatabaseV36")]
    partial class UpdateDatabaseV36
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.ChickenBatch", b =>
                {
                    ...
                    b.Property<int>("InitChickenQuantity")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MaxGrowDays")
                        .HasColumnType("integer");

                    b.Property<int>("MinGrowDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.HarvestProduct", b =>
                {
                    ...
                    b.Property<string>("HarvestProductCode")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.QuantityLogDetail", b =>
                {
                    b.Property<Guid>("QuantityLogDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("gen_random_uuid()");
                    ...
                    b.HasKey("QuantityLogDetailId")
                        .HasName("QuantityLogDetail_pkey");

                    b.HasIndex("QuantityLogId");

                    b.ToTable("QuantityLogDetail", (string)null);
                });
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.StockReceipt", b =>
                {
                    ...
                    b.Property<Guid>("LastEditedByUserUserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("StockReceiptCode")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.StockReceiptDetail", b =>
                {
                    b.Property<Guid>("StockReceiptDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("gen_random_uuid()");
                    ...
                    b.Property<Guid>("ToWareId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("UnitId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("WarehouseWareId")
                        .HasColumnType("uuid");

                    b.HasKey("StockReceiptDetailId")
                        .HasName("StockReceiptDetail_pkey");
                    ...
                    b.HasIndex("WarehouseWareId");

                    b.ToTable("StockReceiptDetail", (string)null);
                });
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.VaccineLog", b =>
                {
                    ...
                    b.Property<DateTime?>("VccineDate")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.ChickenBatch", b =>
                {
                    ...
                    b.HasOne("CFMS.Domain.Entities.GrowthStage", "CurrentStage")
                        .WithMany("ChickenBatches")
                    ...
                    b.HasOne("CFMS.Domain.Entities.ChickenBatch", "ParentBatch")
                        .WithMany()
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.QuantityLogDetail", b =>
                {
                    b.HasOne("CFMS.Domain.Entities.QuantityLog", "QuantityLog")
                        .WithMany("QuantityLogDetails")
                        .HasForeignKey("QuantityLogId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("QuantityLogDetail_QuantityLogId_fkey");

                    b.Navigation("QuantityLog");
                });
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.StockReceiptDetail", b =>
                {
                    ...
                    b.HasOne("CFMS.Domain.Entities.StockReceipt", "StockReceipt")
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.QuantityLog", b =>
                {
                    b.Navigation("QuantityLogDetails");
                });
            ...
            modelBuilder.Entity("CFMS.Domain.Entities.Supplier", b =>
                {
                    ...
                    b.Navigation("ResourceWareStocks");
                });
